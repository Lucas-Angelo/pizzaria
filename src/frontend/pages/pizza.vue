<template>
  <v-row>
    <v-col>
      ...
      <v-row>
        <v-col>
          <v-btn class="btn-new" color="success" @click.stop="clearForm();dialog = true">
      ...
      <v-dialog v-model="dialog" max-width="450">
        <v-card>
          <v-card-title class="text-h5"> {{ formData.id ? 'Editar': 'Criar nova' }} Pizza </v-card-title>
          ...
          <v-card-text>
            ...
            >
              <v-text-field
                ...
                :rules="[v => !!v || 'Nome é obrigatório!',  v => v.length <= 45 || 'Nome deve ter menos de 45 caracteres',]"
                label="Nome"
                counter="45"
            />
              <label>Tamanho</label>
              ...
              <v-text-field
                ...
                :rules="[v => !!v || 'URL da foto é obrigatório!',  v => v.length <= 45 || 'Foto deve ter menos de 200 caracteres']"
                label="URL da Imagem"
                counter="200"
                />
            </v-form>
          ...
          <v-card-actions>
            ...
            <v-btn color="primary" @click="submit"> {{ formData.id ? 'Salvar': 'Criar' }} </v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-col>
