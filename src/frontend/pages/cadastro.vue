    ...
    <v-row align="center" justify="center">
      <v-col cols="12" sm="12" md="7" lg="6">
        <v-card width="100%" style="padding: 2vh">
          ...
          <v-card-text class="register-card-text" style="padding: 5vh">
                ...
                <v-col cols="12" sm="12">
                  <v-text-field
                    ...
                    :rules="[
                      ...
                      (v) =>
                        (v && v.length < 60) ||
                        'Email deve ser menor que 60 caracteres',
                    ]"
                  ></v-text-field>
                </v-col>
                <!--SENHA-->
                <v-col cols="12" sm="12">
                  <v-text-field
                    ...
                    :rules="[
                      ...
                      (v) =>
                        (v && v.length < 50) ||
                        'Senha deve ser menor que 50 caracteres',
                    ]"
            ...
            <v-row no-gutters>
              <v-flex align-self-center>
                ...
                <div class="text-center mt-1">
                  <p>
                    Já possuí uma conta?
                    <a id="linkLogin" @click="redirectToLogin()"> Entre </a>
                  </p>
                </div>
              </v-flex>
            </v-row>
